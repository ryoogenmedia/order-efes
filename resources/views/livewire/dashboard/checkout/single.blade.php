                                ...
                                <div>
                                    <div class="col-sm-12">
                                        <div class="mb-0">
                                            ...
                                            <span class="text-info text-capitalize"># NOTE : Silahkan kirim gambar
                                                sketsa
                                                sebagai
                            ...
                            <div class="tab-pane fade " id="pills-payment" role="tabpanel"
                                        ...
                                        <div data-bs-toggle="collapse" data-bs-target="#paymentmethodCollapse"
                                            ...
                                            <div class="form-check card-radio">
                                                ...
                                                <label class="form-check-label" for="paymentMethod02">
                                                    ...
                                                    <span class="fs-14 text-wrap text-uppercase">{{ $kontak->bank
                                                        }}</span>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="collapse show">
                                    <div class="text-muted mt-2 fst-italic">
                                        <i class="text-muted icon-xs"></i> Silahkan Melakukan Pembayaran ke Bank dibawah
                                        ini
                                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="text-muted mb-0">Rp {{ number_format($produk->harga , 2 , ',' , '.')
                                            }} x
                                            {{ $jml_pesan }}</p>
                                        <div>
