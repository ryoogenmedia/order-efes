<ul class="navbar-nav" id="navbar-nav">
    ...
    @foreach (config('efes.user.navbar') as $navbar )
    @if ($navbar['sub'] != [])
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="{{ $navbar['url'] }}">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.'.$sub['url']) }}" class="nav-link  text-capitalize  "
    ...
    @else
    <li class="nav-item">
        <a class="nav-link menu-link text-capitalize" href="{{ route('dashboard.'.$navbar['url']) }}">
